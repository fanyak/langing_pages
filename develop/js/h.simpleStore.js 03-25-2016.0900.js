    ...
    renderProducts: function (products, s) {
        ...
        s.container.fadeOut(s.fadeSpeed, function () {
            ...
            products.forEach(function (product, i) {
                ...
                // OG Note: author using jQuery .html() Method via mime-type=x-tempalte
                // Author Blog Post = http://codoki.com/2015/09/01/native-javascript-templating/
                // Pro v Con Discussion = https://www.reddit.com/r/webdev/comments/3jhfc3/native_javascript_templating_goodbye_handlebars/
                // NOTE: Handlebars Helpers don't allow async = http://stackoverflow.com/questions/20716240/handlebar-js-helpers-with-asynchronous-data
                if (!product.soldOut) {
